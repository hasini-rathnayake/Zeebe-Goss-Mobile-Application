...
import 'package:user_zeebe_app/models/wishlist_model.dart';
...
// Firebase
  Future<void> addToWishlistFirebase({
    ...
    try {
      ...
      Fluttertoast.showToast(msg: "Item has been added", fontSize: 20);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> removeWishlistItemFromFirestore({
    ...
    try {
      ...
      Fluttertoast.showToast(msg: "Item has been removed", fontSize: 20);
    } catch (e) {
      rethrow;
    }
  }
